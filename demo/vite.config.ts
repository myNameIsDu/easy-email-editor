...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@hy/easy-email-editor/lib/style.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      '@hy/easy-email-extensions/lib/style.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      ...
      '@hy/easy-email-core': path.resolve('../packages/easy-email-core/src/index.tsx'),
      '@hy/easy-email-editor/lib/locales.json': path.resolve(
        '../packages/easy-email-editor/public/locales.json',
      ),
      '@hy/easy-email-localization': path.resolve('../packages/easy-email-localization'),
      '@hy/easy-email-editor': path.resolve(
        '../packages/easy-email-editor/src/index.tsx',
      ),
      '@hy/easy-email-extensions': path.resolve(
