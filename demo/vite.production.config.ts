...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@hy/easy-email-core': path.resolve('../packages/easy-email-core'),
      '@hy/easy-email-editor': path.resolve('../packages/easy-email-editor'),
      '@hy/easy-email-extensions': path.resolve('../packages/easy-email-extensions'),
    },
  },
  optimizeDeps: {},
  define: {},
